    ...
    <div className="space-y-5 max-w-3xl">
      ...
      <div className="rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
        <div className="bg-gradient-to-r from-slate-800 to-slate-700 px-5 py-3.5">
          <span className="text-white font-bold text-sm">Supplier Details</span>
        </div>
      ...
      <div className="rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
        <div className="bg-gradient-to-r from-slate-800 to-slate-700 px-5 py-3.5">
          <span className="text-white font-bold text-sm">Order Items</span>
        </div>
      ...
      <div className="rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
        <div className="bg-gradient-to-r from-slate-800 to-slate-700 px-5 py-3.5">
          <span className="text-white font-bold text-sm">Notes &amp; Actions</span>
        </div>
